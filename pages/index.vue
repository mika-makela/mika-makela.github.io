<template>
  <main class="min-h-screen bg-gray-950">
    ...
    <nav class="sticky top-0 z-10 bg-gray-950/80 backdrop-blur-md border-b border-gray-800/60 no-print">
      <div class="max-w-3xl mx-auto px-5 h-12 flex items-center justify-between gap-2">
        <!-- Home link -->
        <a href="https://mikam.info" aria-label="Home" title="Home"
          class="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-accent transition-colors">
